...
export default function HomeSectionNav({ activeSection }: HomeSectionNavProps) {
  ...
  return (
    ...
    >
      <div className="pointer-events-auto rounded-[2rem] border border-black/10 bg-white/70 p-2 text-slate-900 shadow-[0_24px_64px_-30px_rgba(15,23,42,0.45)] backdrop-blur-2xl lg:w-60 lg:p-3 dark:border-white/15 dark:bg-slate-900/45 dark:text-white">
              ...
              >
                ...
                >
                  <span
                    className={cn(
                      ...
                      isActive
                        ? "border-black/15 bg-white shadow-[0_10px_24px_-16px_rgba(15,23,42,0.9)] dark:border-white/15 dark:bg-white/12 dark:shadow-[0_10px_24px_-16px_rgba(2,6,23,0.9)]"
                        : isComplete
                          ? "border-emerald-300/70 bg-emerald-50 dark:border-[#27ffc3]/40 dark:bg-[#27ffc3]/10"
                          : "border-black/10 bg-white/45 dark:border-white/12 dark:bg-white/8"
                    )}
                  >
                    <span
                      className={cn(
                ...
                {index < homeSections.length - 1 ? (
                  <div className="hidden w-full py-1 lg:flex lg:justify-start">
                    <span
                      aria-hidden="true"
                      className="ml-4 h-7 w-px rounded-full bg-black/10 dark:bg-white/10"
                    >
                      <span
                        className={cn(
